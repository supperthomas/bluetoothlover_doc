...
![image-20210424145410780](image/image-20210424145410780.png)
...
![image-20210424150236734](image/image-20210424150236734.png)
...
![image-20210424151809380](image/image-20210424151809380.png)
...
![image-20210421093830190](image/image-20210421093830190.png)
...
![image-20210423164014169](image/image-20210423164014169.png)
...
![image-20210423171129401](image/image-20210423171129401.png)

SimpleSection.c里面，我们调用了printf的时候，用到了一个字符串常量“%d\n”,它是一种只读数据，所以被放到.rodata段，通过查阅ASSIC码表， 0x25对应的ASSIC码为%d， 0x64对应字母d, 0x0a对应\n，最后的0x0表示\0

![image-20210423171325178](image/image-20210423171325178.png)
...
![image-20210423172835189](image/image-20210423172835189.png)
...
![image-20210423173937330](image/image-20210423173937330.png)
...
![image-20210423194022796](image/image-20210423194022796.png)
...
![image-20210423193710075](image/image-20210423193710075.png)

![image-20210423193723154](image/image-20210423193723154.png)

![image-20210423193748446](image/image-20210423193748446.png)



elf文件类型有3种：

![image-20210423193855180](image/image-20210423193855180.png)



#### 段表

![image-20210423194009546](image/image-20210423194009546.png)
...
![image-20210424125803145](image/image-20210424125803145.png)

#### 段类型说明

![image-20210424125948144](image/image-20210424125948144.png)

![image-20210424130035983](image/image-20210424130035983.png)

结合前面获取到的段信息，对应上面的表格，可以知道对应的段类型

![image-20210424130706273](image/image-20210424130706273.png)

#### 段标志

段标志，表示对应的段，在进程虚拟地址空间中的属性，比如是否可写，可执行等

![image-20210424130916276](image/image-20210424130916276.png)



#### 重定位表

![image-20210424133555149](image/image-20210424133555149.png)

![image-20210424131455268](image/image-20210424131455268.png)

![image-20210424131504981](image/image-20210424131504981.png)

#### 字符串表

![image-20210424135002222](image/image-20210424135002222.png)



![image-20210424133940021](image/image-20210424133940021.png)

![image-20210424134056522](image/image-20210424134056522.png)

![image-20210424134233398](image/image-20210424134233398.png)



常规字符串表

![image-20210424135038938](image/image-20210424135038938.png)
...
![image-20210424135225836](image/image-20210424135225836.png)
...
![image-20210424140438786](image/image-20210424140438786.png)



符号类型和绑定信息：

![image-20210424140813242](image/image-20210424140813242.png)

一个无符号 8bit数据，低4bit（0~0xf）表示符号的类型

![image-20210424140946987](image/image-20210424140946987.png)

高4bit表示符号绑定信息

![image-20210424140914932](image/image-20210424140914932.png)
...
![image-20210424142556162](image/image-20210424142556162.png)

![image-20210424142732884](image/image-20210424142732884.png)

![image-20210424142751558](image/image-20210424142751558.png)

![image-20210424142844810](image/image-20210424142844810.png)
...
![image-20210423091407605](image/image-20210423091407605.png)

![image-20210423091428549](image/image-20210423091428549.png)

![image-20210423091453383](image/image-20210423091453383.png)
